...
var _TextArea3 = require('semantic-ui-react/dist/commonjs/addons/TextArea/TextArea');

var _TextArea4 = _interopRequireDefault(_TextArea3);

var _Input3 = require('semantic-ui-react/dist/commonjs/elements/Input/Input');

var _Input4 = _interopRequireDefault(_Input3);

var _Form3 = require('semantic-ui-react/dist/commonjs/collections/Form/Form');
  ...
  _createClass(FormsyInput, [{
    ...
    value: function () {
      function render() {
        ...
        var shortHandMode = inputAs === _Form4['default'].Input || inputAs === _Form4['default'].TextArea;
        var inputNode = shortHandMode ? (0, _react.createElement)(inputAs).props.control : inputAs;

        if (shortHandMode) {
          delete inputProps.label;
          if (inputAs === _Form4['default'].TextArea) delete inputProps.error;
        }

        return _react2['default'].createElement(
          _Form4['default'].Field,
          {
            as: as,
            className: className,
...
FormsyInput.propTypes = {
  ...
  inputAs: _propTypes2['default'].oneOf([_Input4['default'], _TextArea4['default'], _Form4['default'].Input, _Form4['default'].TextArea]),
