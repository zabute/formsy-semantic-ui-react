...
var FormsyRadioGroup = (_temp2 = _class = function (_Component) {
  ...
  function FormsyRadioGroup() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FormsyRadioGroup.__proto__ || Object.getPrototypeOf(FormsyRadioGroup)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function () {
      var _this2;
...
var _temp3 = function () {
  ...
  __REACT_HOT_LOADER__.register(FormsyRadioGroup, 'FormsyRadioGroup', 'src/FormsyRadioGroup.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/FormsyRadioGroup.js');
}();
