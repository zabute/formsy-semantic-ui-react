...
var _Radio3 = require('semantic-ui-react/dist/commonjs/addons/Radio/Radio');

var _Radio4 = _interopRequireDefault(_Radio3);

var _Checkbox3 = require('semantic-ui-react/dist/commonjs/modules/Checkbox/Checkbox');
  ...
  _createClass(FormsyCheckbox, [{
    ...
    value: function () {
      function render() {
        ...
        if (inputAs === _Checkbox4['default'] || inputAs === _Radio4['default']) delete checkboxProps.error;
...
FormsyCheckbox.propTypes = {
  ...
  inputAs: _propTypes2['default'].oneOf([_Form4['default'].Checkbox, _Form4['default'].Radio, _Checkbox4['default'], _Radio4['default']]),
