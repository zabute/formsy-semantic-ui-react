...
}, _class.Checkbox = function (props) {
  return _react2['default'].createElement(_FormsyCheckbox2['default'], _extends({ as: _semanticUiReact.Form.Checkbox }, props));
...
}, _class.Button = _semanticUiReact.Form.Button, _class.Radio = _semanticUiReact.Form.Radio, _class.Field = _semanticUiReact.Form.Field, _class.Group = _semanticUiReact.Form.Group, _temp2);
