...
var Form = (_temp2 = _class = function (_Component) {
  ...
  function Form() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Form.__proto__ || Object.getPrototypeOf(Form)).call.apply(_ref, [this].concat(args))), _this), _this.updateInputsWithError = function () {
      var _this2;

      return (_this2 = _this).__updateInputsWithError__REACT_HOT_LOADER__.apply(_this2, arguments);
      ...
      function render() {
        ...
        return _react2['default'].createElement(
          ...
          _extends({
            ...
            ref: function () {
              function ref(_ref2) {
                return _this4.formsyForm = _ref2;
              }
...
var _temp3 = function () {
  ...
  __REACT_HOT_LOADER__.register(Form, 'Form', 'src/Form.js');
}();
