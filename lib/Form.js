...
var _Form2 = require('semantic-ui-react/dist/commonjs/collections/Form/Form');
...
Form.Input = function (props) {
  return _react2['default'].createElement(_FormsyInput2['default'], _extends({ inputAs: _Form3['default'].Input }, props));
};

Form.TextArea = function (props) {
  return _react2['default'].createElement(_FormsyTextArea2['default'], _extends({ inputAs: _Form3['default'].TextArea }, props));
};

Form.Select = function (props) {
  return _react2['default'].createElement(_FormsySelect2['default'], _extends({ inputAs: _Form3['default'].Select }, props));
};
...
Form.Dropdown = function (props) {
  return _react2['default'].createElement(_FormsyDropdown2['default'], _extends({ inputAs: _Form3['default'].Dropdown }, props));
};

Form.Checkbox = _FormsyCheckbox2['default'];
Form.Button = _Form3['default'].Button;
Form.Radio = _Form3['default'].Radio;
Form.Field = _Form3['default'].Field;
Form.Group = _Form3['default'].Group;
