...
var _Select3 = require('semantic-ui-react/dist/commonjs/addons/Select/Select');

var _Select4 = _interopRequireDefault(_Select3);

var _Dropdown3 = require('semantic-ui-react/dist/commonjs/modules/Dropdown/Dropdown');
  ...
  _createClass(FormsyDropdown, [{
    ...
    value: function () {
      function render() {
        ...
        var shortHandMode = inputAs === _Form4['default'].Dropdown || inputAs === _Form4['default'].Select;
...
FormsyDropdown.propTypes = {
  ...
  inputAs: _propTypes2['default'].oneOf([_Dropdown4['default'], _Select4['default'], _Form4['default'].Dropdown, _Form4['default'].Select]),
